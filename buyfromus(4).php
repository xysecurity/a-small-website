...
<div><img src="img/imagenes/bannercboleto.jpg" alt="the main picture" width="100%" height="400px" /></div>
	...
	<div class="row">
		<div class="col-md-5">
			<img src="img/imagenes/minibaner3.jpg"  width="200px" height="250px" >
		</div>
		...
		<div class="row">
				<div class="col-md-2">
					<form action="php/buy.php" method="post"><input value="" type="hidden" id="test" name="test" />
						<input value="4" type="hidden" id="id" name="id" />
