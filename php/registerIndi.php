<?php
	...
	echo 1;	
		...
		if(mysqli_num_rows($data)!=0){
			...
			$query="INSERT INTO user (Correo,Contrasena,Nombre,Apellido,Direccion,Ciudad,Estado, Postal,type) VALUES ('{$_POST["correo"]}','$shaname2','{$_POST["nombre"]}','{$_POST["apellido"]}','{$_POST["direccion"]}','{$_POST["ciudad"]}','{$_POST["estado"]}','{$_POST["postal"]}','1')";
