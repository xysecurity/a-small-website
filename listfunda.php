...
<div id="header" style="height:200px;">
  ...
  <div style="position:relative;top:50px;left:200px">
   ...
   <li><a href="HomeAge.html">Inicil</a></li>
    <li><a class="active" href="listindivi.php">Lista de Voluntarios</a></li>
...
<div class="main">
	...
	<div class="col-md-2" align="center">
		...
		<form action="php/chooseevent.php" method="post" name="choose" id="choose">
