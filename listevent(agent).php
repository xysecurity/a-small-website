...
<div id="header" style="height:200px;">
  ...
  <div style="position:relative;top:50px;left:200px">
   ...
   <li><a href="HomeAge.php">Inicil</a></li>
    ...
    <li><a class="active" href="listevent(agent).php">Eventos</a></li>
...
<div class="col-md-8 offset-4">
	...
	<div class="row">
	<div class="col-md-3 offset-9"><button class="button6" onClick="window.location.href='addevent.php'">Agregar</button></div>
	</div>
<div id="wrapper1" class="main">
	...
	<div class="col-md-2" align="center">
		...
		<form action="editevent.php" method="post" name="choose" id="choose">
...
<div class="col-md-1" style="font-size:14px">
<a><button type="submit" class="button1" onclick=" document.getElementById('listid').value={$result[$a*3][4] };" ><img src="img/imagenes/modify_16inch.png" /></button></a>
</div>
<div class="col-md-2" style="font-size:14px">
<button type="button" class="button1" onclick="window.location.href='php/deleteevent.php?listid={$result[$a*3][4]}'" ><img src="img/imagenes/delete_16inch.png" /></button>
</div>			
</div>
EOT;
...
<div class="col-md-1" style="font-size:14px">
<a><button type="submit" class="button1" onclick=" document.getElementById('listid').value={$result[$a*3+1][4] };" ><img src="img/imagenes/modify_16inch.png" /></button></a>
</div>
<div class="col-md-2" style="font-size:14px">'
<button type="button" class="button1" onclick="window.location.href='php/deleteevent.php?listid={$result[$a*3+1][4]}'" ><img src="img/imagenes/delete_16inch.png" /></button>
</div>			
</div>
EOT;
...
<div class="col-md-1" style="font-size:14px">
<a><button type="submit" class="button1" onclick=" document.getElementById('listid').value={$result[$a*3+2][4] };" ><img src="img/imagenes/modify_16inch.png" /></button></a>
</div>
<div class="col-md-2" style="font-size:14px">'
<button type="button" class="button1" onclick="window.location.href='php/deleteevent.php?listid={$result[$a*3+2][4]}'" ><img src="img/imagenes/delete_16inch.png" /></button>
</div>			
</div>
EOT;
