...
<div id="header" style="height:200px;">
  ...
  <div style="position:relative;top:50px;left:500px">
	<ul>
    <li><a href="listevent(fundation).php">Inicio</a></li>
    <li><a class="active" href="profile(fundation).php">Fundation</a></li>
...
<div><img src="img/imagenes/bannercontacto.jpg" alt="the main picture" width="100%" height="400px" /></div>
	...
	<div style="text-align:left"><strong style="font-size:30px">Tu Informacion del Perfil</strong></div>
		...
		<div class="col-md-4" style="font-size:2px;">
			<div class="row">
				<div class="col-md-12">
			<img src="img/imagenes/1.png" width="30px"><a style="width:10px;"><?php echo $row['Nombre']; ?></a>
			  </div>
		  </div>
			<div class="row">
				<div class="col-md-12">
			<img src="img/imagenes/1.png" width="30px"><a style="width:10px;"><?php echo $row['Apellido']; ?></a>
			  </div>
		  </div>
			<div class="row">
				<div class="col-md-12">
			<img src="img/imagenes/1.png" width="30px"><a style="width:10px;"><?php echo $row['Usuario'] ?> </a>
			  </div>
		  </div>
			<div class="row">
		  </div>
		...
		<div class="col-md-4" style="font-size:2px;">
			<div class="row">
				<div class="col-md-12">
			<img src="img/imagenes/1.png" width="30px"><a style="width:10px;"><?php echo $row['Direccion']; ?></a>
			  </div>
		  </div>
			<div class="row">
				<div class="col-md-12">
			<img src="img/imagenes/1.png" width="30px"><a style="width:10px;"><?php echo $row['Telefono']; ?></a>
			  </div>
		  </div>
		  <div class="row">
				<div class="col-md-12" style="overflow: hidden;width:5px;">
			<img src="img/imagenes/1.png" width="30px"><a style="width: 10px;position: relative;"><?php echo $row['Ciudad']; ?></a>
					</div>
				</div>
		...
		<div class="col-md-4"><img src="<?php echo $row['img'] ?>" width="100px" height="100px"></div>
			...
			<form id="update" action="php/updateindi.php" method="post" enctype="multipart/form-data">
				...
				<div class="col-md-4">
					<div class="row">
					<img name="showimg" id="showimg" src="<?php echo $row['img'] ?>"width="120px" height="150px"></div>
			<div class="row">
